    ...
    <div className="w-full bg-white font-sans md:px-10" ref={containerRef}>
      <div className="max-w-7xl mx-auto py-10 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 text-black max-w-4xl font-bold">
          How Annapoorna Works
        </h2>
        <p className="text-neutral-700 text-sm md:text-base max-w-sm">
          From surplus to sustenance in 4 simple steps.
        </p>
      </div>
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-0.5 bg-[linear-gradient(to_top,rgba(139,92,246,1),rgba(59,130,246,1),rgba(0,0,0,0))] rounded-full"
          />
        </div>
      </div>
    </div>
